...
- (void)setTopOfOriginalScrollViewContentInset:(CGFloat)top {

    originalScrollViewContentInset.top = top;
}
...
- (void)setPullToRefreshActionHandler:(void (^)(void))actionHandler {
    ...
    titleLabel.text = NSLocalizedString(@"下拉即可刷新...",);
    ...
    if(pullToRefreshActionHandler) {
        switch (newState) {
            ...
            case SVPullToRefreshStateTriggered:
                titleLabel.text = NSLocalizedString(@"释放立即刷新...",);
